...
- **Justificación del algoritmo:** En mis sistema del café los datos representan transacciones comerciales que se busca y se esperan que escalen de una manera rápida conforme el negocio progresa. Merge sort tiende a mantener el mismo rendimiento y complejidad sin importar el volumen de los pedidos, por lo que puede garantizar tiempos de respuestas prácticamente instantaneos. Además su tiempo de ejecución es totalmente determínistico por lo que nunca habrá un escenario en el que el sistema se retrase por datos en un orden desfavorable.
